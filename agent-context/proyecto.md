...
- **apa** — agente de programación autónoma
- **model_broker** — servicio de modelos
- **contexto_zai** — proceso de recuperación de context del agente Z.ai 
